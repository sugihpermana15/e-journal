                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.ejournal.settings.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="border rounded">
                            ...
                            <div class="col-12 col-lg-3 border-lg-end">
                                <div class="p-3 sticky-top ejournal-settings-sidebar">
                                    ...
                                    <div class="list-group mb-3">
                                        ...
                                        <a class="list-group-item list-group-item-action py-2" href="#section-about-page">About Page</a>
                                    </div>
                            ...
                            <div class="col-12" id="section-about-page">
                                <h6 class="mb-1">About Page</h6>
                                <div class="text-muted small">Content for public <code>/about</code> page. Uses the same settings record (no duplicate inputs).</div>
                                <div class="text-muted small">Mapping: Tagline/Heading/Text/Counters/Images/CTA/Phone are editable here. The section title "Vision &amp; Mission" (center heading) is currently fixed in template.</div>
                            </div>

                            <div class="col-12 col-md-4">
                                <label class="form-label">Tagline</label>
                                <input class="form-control" name="home[about_page][tagline]" value="{{ old('home.about_page.tagline', $aboutPageTagline) }}">
                            </div>

                            <div class="col-12">
                                <label class="form-label">Heading HTML (allowed: &lt;br&gt; and &lt;span&gt;)</label>
                                <textarea class="form-control" name="home[about_page][heading_html]" rows="3">{{ old('home.about_page.heading_html', $aboutPageHeadingHtml) }}</textarea>
                                <div class="form-text">This is the big title on the right side. Use <code>&lt;br&gt;</code> to break lines.</div>
                            </div>

                            <div class="col-12">
                                <label class="form-label">Text</label>
                                <textarea class="form-control" name="home[about_page][text]" rows="4">{{ old('home.about_page.text', $aboutPageText) }}</textarea>
                                <div class="form-text">Main paragraph under the About Page title.</div>
                            </div>

                            <div class="col-12">
                                <div class="border rounded p-3">
                                    <div class="fw-semibold mb-2">About Page Images (4)</div>
                                    <div class="text-muted small mb-2">These replace the 4 images on the left side of the About page.</div>
                                    <div class="text-muted small mb-2">Order: #1 top-left, #2 bottom-left, #3 top-right, #4 bottom-right.</div>
                                    <div class="row g-3">
                                        @foreach($aboutPageImages as $i => $img)
                                            <div class="col-12 col-md-3">
                                                <label class="form-label">Image #{{ $i + 1 }}</label>
                                                <input class="form-control" type="file" name="home[about_page][images][{{ $i }}][image_file]" accept="image/*">
                                                @if(data_get($img, 'image'))
                                                    <div class="form-text">Current: {{ data_get($img, 'image') }}</div>
                                                @endif
                                            </div>
                            ...
                            <div class="col-12">
                                <div class="border rounded p-3">
                                    <div class="fw-semibold mb-2">Counters (3)</div>
                                    <div class="text-muted small mb-2">Shown under the About Page paragraph. If Count is empty/0, it may look wrong on the UI.</div>
                                    <div class="row g-3">
                                        @foreach($aboutPageCounters as $i => $c)
                                            <div class="col-12 col-md-4">
                                                <div class="border rounded p-2 h-100">
                                                    ...
                                                    <input class="form-control" type="number" min="0" name="home[about_page][counters][{{ $i }}][count]" value="{{ old('home.about_page.counters.' . $i . '.count', data_get($c, 'count')) }}">
                                                    <label class="form-label mt-2">Suffix (ex: +, %)</label>
                                                    <input class="form-control" name="home[about_page][counters][{{ $i }}][suffix]" value="{{ old('home.about_page.counters.' . $i . '.suffix', data_get($c, 'suffix')) }}">
                                                    <label class="form-label mt-2">Label</label>
                                                    <input class="form-control" name="home[about_page][counters][{{ $i }}][label]" value="{{ old('home.about_page.counters.' . $i . '.label', data_get($c, 'label')) }}">
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="border rounded p-3">
                                    <div class="fw-semibold mb-2">CTA + Contact</div>
                                    <div class="text-muted small mb-2">Phone link is generated with <code>tel:</code>. Use international format (example: <code>+62 897...</code>).</div>
                                    <div class="row g-3">
                                        <div class="col-12 col-md-4">
                                            <label class="form-label">Button Text</label>
                                            <input class="form-control" name="home[about_page][consultation_button_text]" value="{{ old('home.about_page.consultation_button_text', $aboutPageConsultText) }}">
                                        </div>
                                        <div class="col-12 col-md-8">
                                            <label class="form-label">Button URL</label>
                                            <input class="form-control" name="home[about_page][consultation_button_url]" value="{{ old('home.about_page.consultation_button_url', $aboutPageConsultUrl) }}">
                                            <div class="form-text">Example WhatsApp: <code>https://wa.me/628xxxx</code></div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <label class="form-label">Office Hours</label>
                                            <input class="form-control" name="home[about_page][office_hours]" value="{{ old('home.about_page.office_hours', $aboutPageOfficeHours) }}">
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <label class="form-label">Phone</label>
                                            <input class="form-control" name="home[about_page][phone]" value="{{ old('home.about_page.phone', $aboutPagePhone) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="border rounded p-3">
                                    <div class="fw-semibold mb-2">Vision</div>
                                    <div class="row g-3">
                                        <div class="col-12 col-md-4">
                                            <label class="form-label">Title</label>
                                            <input class="form-control" name="home[about_page][vision][title]" value="{{ old('home.about_page.vision.title', data_get($aboutPageVision, 'title', 'Our Vision')) }}">
                                        </div>
                                        <div class="col-12 col-md-8">
                                            <label class="form-label">Subtitle</label>
                                            <input class="form-control" name="home[about_page][vision][subtitle]" value="{{ old('home.about_page.vision.subtitle', data_get($aboutPageVision, 'subtitle', 'A global exchange of knowledge that advances medicine.')) }}">
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Text</label>
                                            <textarea class="form-control" name="home[about_page][vision][text]" rows="4">{{ old('home.about_page.vision.text', data_get($aboutPageVision, 'text')) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="border rounded p-3">
                                    <div class="fw-semibold mb-2">Mission</div>
                                    <div class="row g-3">
                                        <div class="col-12 col-md-4">
                                            <label class="form-label">Title</label>
                                            <input class="form-control" name="home[about_page][mission][title]" value="{{ old('home.about_page.mission.title', data_get($aboutPageMission, 'title', 'Our Mission')) }}">
                                        </div>
                                        <div class="col-12 col-md-8">
                                            <label class="form-label">Subtitle</label>
                                            <input class="form-control" name="home[about_page][mission][subtitle]" value="{{ old('home.about_page.mission.subtitle', data_get($aboutPageMission, 'subtitle', 'How we deliver excellence, access, and trust.')) }}">
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Mission Points (one per line: <code>Title|Text</code>)</label>
                                            <textarea class="form-control" name="home[about_page][mission][points_lines]" rows="8">{{ old('home.about_page.mission.points_lines', $aboutPageMissionPointsLines) }}</textarea>
                                            <div class="form-text">Each line becomes one bullet. The list is automatically split into 2 columns on the About page. Leave an empty line to remove an item.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
