...
@section('title', 'Academy | Med Open Press Admin')
    ...
    <div class="row">
        <div class="col-xxl col-sm-6">
            <div class="card overflow-hidden">
                ...
                <img src="{{ asset('assets/admin/images/dashboard/academy-bg1.png') }}" alt="Academy Image"
        ...
        <div class="col-xxl col-sm-6">
            <div class="card overflow-hidden">
                ...
                <img src="{{ asset('assets/admin/images/dashboard/academy-bg3.png') }}" alt="Academy Image"
                    class="position-absolute bottom-0 right h-100 w-100 object-fit-cover opacity-5">
            </div>
        </div>
        <div class="col-xxl col-sm-6">
            <div class="card overflow-hidden">
                ...
                <img src="{{ asset('assets/admin/images/dashboard/academy-bg2.png') }}" alt="Academy Image"
                    class="position-absolute bottom-0 right h-100 w-100 object-fit-cover opacity-5">
            </div>
        </div>
        <div class="col-xxl col-sm-6">
            <div class="card overflow-hidden">
                ...
                <img src="{{ asset('assets/admin/images/dashboard/academy-bg4.png') }}" alt="Academy Image"
                    class="position-absolute bottom-0 right h-100 w-100 object-fit-cover opacity-5">
            </div>
        </div>
        <div class="col-xxl col-sm-6">
            <div class="card overflow-hidden">
                ...
                <img src="{{ asset('assets/admin/images/dashboard/academy-bg5.png') }}" alt="Academy Image"
                    class="position-absolute bottom-0 right h-100 w-100 object-fit-cover opacity-5">
            </div>
        </div>
    </div>
            ...
            <div class="card card-h-100">
                ...
                <div class="card-body position-relative">
                    ...
                    <div class="d-flex align-items-end justify-content-between">
                        ...
                        <img src="{{ asset('assets/admin/images/dashboard/student.png') }}" class="img-fluid w-160px animation-bounce"
                            alt="Live Session">
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <ul class="list-group list-group-flush list-borderless">
                        <li class="list-group-item d-flex justify-content-between py-3">
                            <div class="d-flex gap-3">
                                <img src="{{ asset('assets/images/resources/logoMed.png') }}" alt="Instructor"
...
@section('js')
    ...
    <script src="{{ asset('assets/admin/js/dashboard/academy.init.js') }}"></script>
