            ...
            <div class="me-auto">
                <div class="d-inline-flex align-items-center gap-5">
                    <a href="{{ route('admin.dashboard') }}" class="fs-18 fw-semibold">
                        <img height="30" class="header-sidebar-logo-default d-none" alt="Med Open Press" src="{{ asset('assets/images/resources/logoMed.png') }}">
                        <img height="30" class="header-sidebar-logo-light d-none" alt="Med Open Press" src="{{ asset('assets/images/resources/logoMed.png') }}">
                        <img height="30" class="header-sidebar-logo-small d-none" alt="Med Open Press" src="{{ asset('assets/images/resources/logoMed.png') }}">
                        <img height="30" class="header-sidebar-logo-small-light d-none" alt="Med Open Press" src="{{ asset('assets/images/resources/logoMed.png') }}">
                    </a>
            ...
            <div class="flex-shrink-0 d-flex align-items-center gap-1">
                ...
                <div class="dropdown pe-dropdown-mega d-none d-md-block">
                    <button class="btn btn-icon header-btn p-1" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="{{ asset('assets/admin/images/flag/us.svg') }}" alt="Flag Image" height="16" width="16" class="object-fit-cover rounded">
                    </button>
                    <ul class="dropdown-menu header-dropdown-menu">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-2" href="javascript:void(0)">
                                <img src="{{ asset('assets/admin/images/flag/cn.svg') }}" alt="Flag Image" height="16" width="16" class="object-fit-cover rounded">
                                Chinese
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-2" href="javascript:void(0)">
                                <img src="{{ asset('assets/admin/images/flag/sa.svg') }}" alt="Flag Image" height="16" width="16" class="object-fit-cover rounded">
                                Arabic
                            </a>
                        </li>
                    </ul>
                ...
                <div class="dropdown pe-dropdown-mega d-none d-md-block">
                    ...
                    <button class="header-profile-btn btn gap-1 text-start" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div class="d-none d-lg-block pe-2">
                            <span class="d-block mb-0 fs-13 fw-semibold">{{ $user?->name ?? 'User' }}</span>
                            <span class="d-block mb-0 fs-12 text-muted">{{ $user?->role ? ucfirst($user->role) : '' }}</span>
                        </div>
                    </button>
                    <div class="dropdown-menu dropdown-mega-sm header-dropdown-menu p-3">
                        <div class="border-bottom pb-2 mb-2 d-flex align-items-center gap-2">
                            <img src="{{ \Laravolt\Avatar\Facade::create($user?->name ?? 'User')->toBase64() }}" alt="Avatar Image" class="avatar-md">
                            <div>
                                <a href="javascript:void(0)">
                                    <h6 class="mb-0 lh-base">{{ $user?->name ?? 'User' }}</h6>
                                </a>
