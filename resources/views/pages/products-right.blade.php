                ...
                <div class="product__items">
                    ...
                    <div class="product__all">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-6 col-lg-6 col-md-6">
                                                                <div class="single-product-style2__img">
                                                                    <img src="{{ asset('assets/images/shop/shop-product-2-1.jpg') }}" alt="">
                                                                    <img src="{{ asset('assets/images/shop/shop-product-2-1.jpg') }}" alt="">
                                                                    <ul class="single-product-style1__overlay">
                                                                        <li>
                                                                            <p>New</p>
                                                ...
                                                <div class="col-xl-6 col-lg-6">
                                                    <div class="single-product-style2">
                                                        <div class="row">
                                                            <div class="col-xl-6 col-lg-6 col-md-6">
                                                                <div class="single-product-style2__img">
                                                                    <img src="{{ asset('assets/images/shop/shop-product-2-2.jpg') }}" alt="">
                                                                    <img src="{{ asset('assets/images/shop/shop-product-2-2.jpg') }}" alt="">
                                                                </div>
                                                            </div>
                                                            <div class="col-xl-6 col-lg-6 col-md-6">
                                                ...
                                                <div class="col-xl-6 col-lg-6">
                                                    <div class="single-product-style2">
                                                        <div class="row">
                                                            <div class="col-xl-6 col-lg-6 col-md-6">
                                                                <div class="single-product-style2__img">
                                                                    <img src="{{ asset('assets/images/shop/shop-product-2-4.jpg') }}" alt="">
                                                                    <img src="{{ asset('assets/images/shop/shop-product-2-4.jpg') }}" alt="">
                                                                </div>
                                                            </div>
                                                            <div class="col-xl-6 col-lg-6 col-md-6">
                                                ...
                                                <div class="col-xl-6 col-lg-6">
                                                    <div class="single-product-style2">
                                                        <div class="row">
                                                            <div class="col-xl-6 col-lg-6 col-md-6">
                                                                <div class="single-product-style2__img">
                                                                    <img src="{{ asset('assets/images/shop/shop-product-2-5.jpg') }}" alt="">
                                                                    <img src="{{ asset('assets/images/shop/shop-product-2-5.jpg') }}" alt="">
                                                                </div>
                                                                <ul class="single-product-style1__overlay">
                                                                    <li>
                                                ...
                                                <div class="col-xl-6 col-lg-6">
                                                    <div class="single-product-style2">
                                                        <div class="row">
                                                            <div class="col-xl-6 col-lg-6 col-md-6">
                                                                <div class="single-product-style2__img">
                                                                   <img src="{{ asset('assets/images/shop/shop-product-2-6.jpg') }}" alt="">
                                                                   <img src="{{ asset('assets/images/shop/shop-product-2-6.jpg') }}" alt="">
                                                                </div>
                                                            </div>
                                                            <div class="col-xl-6 col-lg-6 col-md-6">
                                                ...
                                                <div class="col-xl-6 col-lg-6">
                                                    <div class="single-product-style2">
                                                        <div class="row">
                                                            <div class="col-xl-6 col-lg-6 col-md-6">
                                                                <div class="single-product-style2__img">
                                                                    <img src="{{ asset('assets/images/shop/shop-product-2-8.jpg') }}" alt="">
                                                                    <img src="{{ asset('assets/images/shop/shop-product-2-8.jpg') }}" alt="">
                                                                </div>
                                                            </div>
                                                            <div class="col-xl-6 col-lg-6 col-md-6">
                                                ...
                                                <div class="col-xl-6 col-lg-6">
                                                    <div class="single-product-style2">
                                                        <div class="row">
                                                            <div class="col-xl-6 col-lg-6 col-md-6">
                                                                <div class="single-product-style2__img">
                                                                    <img src="{{ asset('assets/images/shop/shop-product-2-7.jpg') }}" alt="">
                                                                    <img src="{{ asset('assets/images/shop/shop-product-2-7.jpg') }}" alt="">
                                                                    <ul class="single-product-style1__overlay">
                                                                        <li>
                                                                            <p>New</p>
                                                ...
                                                <div class="col-xl-6 col-lg-6">
                                                    <div class="single-product-style2">
                                                        <div class="row">
                                                            <div class="col-xl-6 col-lg-6 col-md-6">
                                                                <div class="single-product-style2__img">
                                                                    <img src="{{ asset('assets/images/shop/shop-product-2-9.jpg') }}" alt="">
                                                                    <img src="{{ asset('assets/images/shop/shop-product-2-9.jpg') }}" alt="">
                                                                    <ul class="single-product-style1__overlay">
                                                                        <li>
                                                                            <p>3% Off</p>
                                                ...
                                                <div class="col-xl-6 col-lg-6">
                                                    <div class="single-product-style2">
                                                        <div class="row">
                                                            <div class="col-xl-6 col-lg-6 col-md-6">
                                                                <div class="single-product-style2__img">
                                                                   <img src="{{ asset('assets/images/shop/shop-product-2-3.jpg') }}" alt="">
                                                                   <img src="{{ asset('assets/images/shop/shop-product-2-3.jpg') }}" alt="">
                                                                </div>
                                                            </div>
                                                            <div class="col-xl-6 col-lg-6 col-md-6">
                        ...
                        <ul class="styled-pagination text-center clearfix">
                            <li class="arrow prev active"><a href="#"><span class="fas fa-arrow-left"></span></a>
                            </li>
                            <li><a href="#">1</a></li>
                            <li><a href="#">2</a></li>
                            <li><a href="#">3</a></li>
